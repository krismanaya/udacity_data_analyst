...
qplot(x = amount, data = merge_bs_dt_df_subset, color = I("black"), 
      fill = I("firebrick4")) + 
...
ggplot(aes(x = amount, color = I("black"), fill = I("firebrick4")), 
...
choose_city_df_sample <- subset(merge_bs_dt_df, 
                                merge_bs_dt_df$city %in% 
                                  c("BAKERSFIELD", "SAN JOSE", "SAN FRANCISCO", 
                                    ...
                                    "HUNTINGTON BEACH"))
qplot(x = city, data = choose_city_df_sample, color = I("black"),
      fill = I("paleturquoise1")) + 
  labs(title = "Bernie v Trump Contributions",
...
ggplot(aes(x = amount, color = I("black"), fill=  I('#F79420')), 
...
#color plot 
ggplot(aes(x = amount, color = I("black"), fill = I('#099DD9')), 
...
ggplot(merge_samp, aes(x = date, y = amount)) + 
  geom_line(aes(color= canidate), stat="identity", 
...
cdf_heatmap <- heatmap(cdf_matrix, Rowv=NA, Colv=NA, 
                       ...
                       scale = "column", margins = c(5,10))  # make heatmap
```
